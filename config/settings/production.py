...
# ── Error logging ──────────────────────────────────────────────────────────────
# Writes ERROR-level tracebacks to /home/middlebe/logs/django_error.log
# Create that directory on the server before deploying: mkdir -p /home/middlebe/logs
LOGGING = {
    'version': 1,
    ...
    'handlers': {
        'file': {
            ...
            'filename': '/home/middlebe/logs/django_error.log',
            'formatter': 'verbose',
        },
    },
    'root': {
